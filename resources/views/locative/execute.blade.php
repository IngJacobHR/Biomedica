                ...
                <div class="card">
                    ...
                    <div class="form-row">
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input class="form-control" type="date" name="date_novelty"   id="id_input" readonly value="{{ old('date_novelty')?? $locative->date_novelty}}">
                              </div>
                              <div class="form-group col-md-6">
                              ...
                              readonly
                              name="report"
                              value="{{ old('report')?? $locative->report}}"
                              >{{$locative->report}}
                              </textarea>
                            </div>
                            @if ($locative->status=='Rechazada')
                            <div class="form-group col-md-6">
                              <label>Comentario</label>
                              <p value="{{ old('location')?? $locative->commentary}}">{{ $locative->date_evaluation}}: {{ $locative->commentary}} </p>
                            </div>
                            <div class="form-group col-md-6">
                              ...
                              readonly
                              name="correction"
                              value="{{ old('correction')?? $locative->correction}}"
                              >{{$locative->correction}}
                              </textarea>
                            </div>
                            @endif
