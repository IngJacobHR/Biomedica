                                ...
                                @foreach($workorders as $work)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-outline-warning" href="{{ route('workorders.edit', ['workorders'=>$work->id]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-alarm" viewBox="0 0 16 16">
