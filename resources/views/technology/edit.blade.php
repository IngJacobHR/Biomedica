                    ...
                    <form method="POST" action="{{route('technology.update', ['technology'=> $technology->id])}}">
                        ...
                        <hr>
                                <div class="form-row">
                                    ...
                                    <input class="form-control" type="text" name="supplier" value="{{ old('supplier')?? $technology->supplier }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                    <label>Fecha de Garantia</label>
                                    <input class="form-control" type="date" name="date_warranty" value="{{ old('date_warranty')?? $technology->date_warranty }}">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                    <label>Costo del equipo</label>
                                    <input class="form-control" type="number" name="value" value="{{ old('value')?? $technology->value }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                    <label>Fecha de Ingreso</label>
                                    <input class="form-control" type="date" name="date_in" value="{{ old('date_in')?? $technology->date_in }}">
                                    </div>
                                </div>
